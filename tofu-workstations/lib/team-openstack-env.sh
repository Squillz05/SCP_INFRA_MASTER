...
# Args: team (red|blue|main), tfvars path, working dir (OpenTofu root with .tf files)
team_openstack_assert_token_matches_tfvars() {
  ...
  [[ "$team" == "main" ]] && var_name="main_project_id"
  ...
  if [[ "$token_project" != "$expected" ]]; then
    ...
    echo "" >&2
    if [[ "$team" == "main" ]]; then
      echo "Use an application credential or openrc scoped to the Main (Grey) project (${expected})." >&2
    else
      echo "Use an application credential created IN the ${team} bridge project (Delta/Foxtrot)," >&2
      echo "or a password openrc scoped to that project — not the wrong tenant." >&2
    fi
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" >&2
    return 1
  fi
